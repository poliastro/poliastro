...
.. |travisci| image:: https://img.shields.io/travis/poliastro/poliastro/0.10.x.svg?style=flat-square
   :target: https://travis-ci.org/poliastro/poliastro

.. |appveyor| image:: https://img.shields.io/appveyor/ci/Juanlu001/poliastro/0.10.x.svg?style=flat-square
   :target: https://ci.appveyor.com/project/Juanlu001/poliastro/branch/0.10.x

.. |codecov| image:: https://img.shields.io/codecov/c/github/poliastro/poliastro.svg?style=flat-square
   :target: https://codecov.io/github/poliastro/poliastro?branch=0.10.x
...
.. |docs| image:: https://img.shields.io/badge/docs-v0.10.0-brightgreen.svg?style=flat-square
   :target: http://docs.poliastro.space/en/v0.10.0/?badge=v0.10.0

.. |license| image:: https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square
   :target: https://github.com/poliastro/poliastro/raw/0.10.x/COPYING
...
.. image:: https://github.com/poliastro/poliastro/raw/0.10.x/docs/source/examples/molniya.png
   :align: center
...
http://docs.poliastro.space/en/v0.10.0/
...
.. |mybinder| image:: https://img.shields.io/badge/launch-binder-e66581.svg?style=flat-square
   :target: https://beta.mybinder.org/v2/gh/poliastro/poliastro/0.10.x?filepath=index.ipynb
...
https://beta.mybinder.org/v2/gh/poliastro/poliastro/0.10.x?filepath=index.ipynb
...
.. _`documentation for alternative installation methods`: http://docs.poliastro.space/en/v0.10.0/getting_started.html#alternative-installation-methods
...
.. _`CONTRIBUTING.rst`: https://github.com/poliastro/poliastro/blob/0.10.x/CONTRIBUTING.rst
...
.. _`Related software`: http://docs.poliastro.space/en/v0.10.0/about.html#related-software
