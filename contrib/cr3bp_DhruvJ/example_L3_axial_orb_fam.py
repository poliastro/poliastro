...
targeted_po_fam, targeted_po_char = npc_po_fam_cr3bp(mu, po_single_shooter_cr3bp, ig, tf_guess, 
                                      ...
                                      step_size = 1e-5, num_fam_members = 3, param_continue='vz', line_search=True)
...
targeted_po_fam_updated, targeted_po_char_updated = palc_po_fam_cr3bp(mu, po_single_shooter_cr3bp, 
                                            targeted_orbit, free_vars, constraints, sym_period_targ=1/2,
                                            step_size = 1e-2*3, num_fam_members = 50, line_search=True)
