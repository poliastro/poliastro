...
from poliastro.twobody import core
...
def test_state_has_attractor_given_in_constructor():
    ...
    ss = core.State(Sun, (_d, _, _a, _a, _a, _a))
...
def test_default_time_for_new_state():
    ...
    ss = core.State(_body, (_d, _, _a, _a, _a, _a))
...
def test_state_has_elements_given_in_constructor():
    ...
    argp = 286.537 * u.deg
    nu = 23.33 * u.deg
    ss = core.State(Sun, (a, ecc, inc, raan, argp, nu))
...
def test_convert_from_rv_to_coe():
    ...
    r, v = core.State(Earth, (a, ecc, inc, raan, argp, nu)).rv
...
def test_convert_from_coe_to_rv():
    ...
    a, ecc, inc, raan, argp, nu = core.State(Earth, (r, v)).elements
    p = a * (1 - ecc ** 2)
