...
from .scalar import ClassicalState, ModifiedEquinoctialState, RVState
...
class ClassicalStateArray(BaseStateArray):
    ...
    def to_vectors(self):
        ...
        return RVStateArray(
            self.epoch.copy(), self.attractor, r * u.km, v * u.km / u.s, self.plane
        )
